...
public class Plant extends ClockDomain{
  ...
  public void thread2186(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest2193 = 0;
        if(ends[8]>=biggest2193){
          biggest2193=ends[8];
        }
        if(ends[9]>=biggest2193){
          biggest2193=ends[9];
        }
        if(ends[10]>=biggest2193){
          biggest2193=ends[10];
        }
        if(ends[11]>=biggest2193){
          biggest2193=ends[11];
        }
        if(ends[12]>=biggest2193){
          biggest2193=ends[12];
        }
        if(ends[13]>=biggest2193){
          biggest2193=ends[13];
        }
        if(biggest2193 == 1){
          active[7]=1;
  ...
  public void thread2172(int [] tdone, int [] ends){
    ...
    int biggest2179 = 0;
    if(ends[8]>=biggest2179){
      biggest2179=ends[8];
    }
    if(ends[9]>=biggest2179){
      biggest2179=ends[9];
    }
    if(ends[10]>=biggest2179){
      biggest2179=ends[10];
    }
    if(ends[11]>=biggest2179){
      biggest2179=ends[11];
    }
    if(ends[12]>=biggest2179){
      biggest2179=ends[12];
    }
    if(ends[13]>=biggest2179){
      biggest2179=ends[13];
    }
    if(biggest2179 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S2165){
        ...
        case 1 : 
          ...
          int biggest2180 = 0;
          if(ends[2]>=biggest2180){
            biggest2180=ends[2];
          }
          if(ends[3]>=biggest2180){
            biggest2180=ends[3];
          }
          if(ends[4]>=biggest2180){
            biggest2180=ends[4];
          }
          if(ends[5]>=biggest2180){
            biggest2180=ends[5];
          }
          if(ends[6]>=biggest2180){
            biggest2180=ends[6];
          }
          if(ends[7]>=biggest2180){
            biggest2180=ends[7];
          }
          if(biggest2180 == 1){
            active[1]=1;
